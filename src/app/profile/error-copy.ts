...
const uz: Record<string, string> = {
  ...
  TRIAL_EXPIRED: "Bepul sinov muddati tugagan.",
  BUSINESS_DEACTIVATED: "Biznes deaktiv qilingan.",
...
const ru: Record<string, string> = {
  ...
  TRIAL_EXPIRED: "Бесплатный пробный период истёк.",
  BUSINESS_DEACTIVATED: "Бизнес деактивирован.",
